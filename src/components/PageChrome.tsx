        ...
        <footer className="rounded-3xl border border-slate-800 bg-slate-900/60 px-6 py-5 text-sm text-slate-400">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-2">
              ...
              <div>
                {legal.sourceLabel}: <span className="font-medium text-slate-300">{legal.sourceDomain}</span>
              </div>
            </div>
            <div className="flex flex-wrap gap-x-4 gap-y-2 leading-6 lg:justify-end lg:text-right">
              <a className="font-semibold text-slate-300 underline-offset-4 hover:underline" href={`./about.html?lang=${lang}`}>
                {legal.about}
              </a>
