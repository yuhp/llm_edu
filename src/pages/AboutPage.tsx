...
const copy = {
  zh: {
    ...
    title: "版权与授权说明",
    subtitle:
      "说明 HCLife Education / 大模型应用课程的品牌、源站、内容版权、授权展示范围与知识共享协议。",
    ...
    cards: [
      ...
      },
      {
        ...
        linkPrefix: "本站内容已独家授权于公司门户（hclife.cn）和个人博客（",
        linkSeparator: "、",
        linkSuffix: "）展示、引用与联播。",
      },
      {
    ...
    licenseTitle: "知识共享协议",
    licenseBody:
      "除另有说明外，本站开放教程内容采用 CC BY-NC-ND 4.0（署名-非商业性使用-禁止演绎）知识共享协议。该协议允许在署名、非商业、不得演绎的前提下分享内容，但不允许商业使用或改编发布。",
    licenseLink: "查看 CC BY-NC-ND 4.0 简体中文协议",
    licenseHref:
      "https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh-hans",
    contactTitle: "授权与合作",
    contactBody:
      "如需转载、课程合作、企业内训或其他授权使用，请先联系版权方并取得书面许可。",
    contactLabel: "联系方式",
  ...
  en: {
    ...
    subtitle:
      "Brand, source domain, copyright ownership, authorized publication channels, and Creative Commons licensing for HCLife Education.",
    footer:
    ...
    cards: [
      ...
      },
      {
        ...
        linkPrefix: "The company portal (hclife.cn) and personal blogs (",
        linkSeparator: " and ",
        linkSuffix:
          ") hold an exclusive license to display, quote, and syndicate this content.",
      },
      {
        icon: ShieldCheck,
    ...
    licenseBody:
      "Unless otherwise noted, open tutorial content is licensed under CC BY-NC-ND 4.0: Attribution, NonCommercial, NoDerivatives. This permits sharing with attribution for non-commercial purposes, but does not allow commercial use or modified redistribution.",
    ...
    contactBody:
      "For republication, course collaboration, enterprise training, or other licensed uses, please contact the copyright holder and obtain written permission first.",
